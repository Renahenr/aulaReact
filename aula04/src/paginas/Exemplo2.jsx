...
export default function Exemplo2()
{
   ...
   function calcular()
   {
       ...
       setResultado(
        <div>
            <p>A soma do {numero1} + {numero2} = {soma}</p>
            <p>A diferença do {numero1} - {numero2} = {diferenca}</p>
            <p>o produto do {numero1} * {numero2} = {produto}</p>
            <p>A divisão do {numero1} / {numero2} = {divisao.toFixed(2)}</p>

            <p>O resto da divisão {numero1} por {numero2} = {resto}</p>
            <p>O exponenciação da divisão {numero1} <sup> {numero2}</sup> = {potencia}</p>
